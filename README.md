...
- **`/`** — 이름/소속 센터/다짐(300자, 실시간 글자수)을 입력해 제출합니다. 제출하면 완료 화면에서 본인 다짐을 다시 보여주고 **수정하기**로 재전송할 수 있습니다. `localStorage`에 제출 id를 저장해 재접속 시 완료 화면으로 바로 이동하며, 전송 중에는 버튼이 비활성화됩니다.
